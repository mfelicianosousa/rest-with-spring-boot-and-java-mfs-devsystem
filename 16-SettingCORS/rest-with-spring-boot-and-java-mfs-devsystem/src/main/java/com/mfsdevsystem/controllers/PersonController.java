...
public class PersonController {
	...
	@Operation(summary = "Finds a Person", description="Finds a Person by their Id.",
	    tags = { "People" },
	    responses = {
	  	@ApiResponse(
	  		description = "Success",
	...
	@CrossOrigin(origins = {"http://localhost:8080","https://mfs-devsystem.com.br"})
	@PostMapping(consumes = {MediaType.APPLICATION_JSON,MediaType.APPLICATION_XML, MediaType.APPLICATION_YML},
				 produces = {MediaType.APPLICATION_JSON,MediaType.APPLICATION_XML,MediaType.APPLICATION_YML})
	@Operation(summary = "Adds a new Person", description="Adds a new Person by passing in a JSON, XML or YML representation",
	    tags = {"People"},
	    responses = {
	  	@ApiResponse(description = "Success", responseCode = "200",
